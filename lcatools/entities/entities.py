...
class LcEntity(object):
    ...
    external_ref = property(get_external_ref, set_external_ref)
    ...
    def merge(self, other):
        """
        Allows to merge two entities with different origins.  The entities must have the same entity_type and
        external_ref.  In the merge, keys present in the other entity are added to the local dict, but keys already
        present locally are not overwritten.
        :param other:
        :return:
        """
